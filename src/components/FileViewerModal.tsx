			...
			<div className="scale-up-animation bg-zinc-900 p-4 md:p-8 rounded-lg border border-zinc-800 w-full md:w-2/3 lg:w-1/2 text-stone-200">
						...
						<h2 className="text-3xl font-bold flex items-center gap-3 ">
							<div className="relative">
								...
								<button
									...
									className="p-1 border border-sky-700 bg-sky-950 rounded-lg text-xs md:text-base hover:bg-sky-900 transition-all duration-300 w-full uppercase flex items-center justify-center gap-2"
								>
								...
								{isFolderDropdownOpen && (
									<div className="absolute top-full left-0 mt-1 bg-zinc-900 p-2 rounded-lg border border-zinc-800 text-stone-200 w-40">
										...
										<div className="flex items-center h-max gap-1">
											...
											<select
												...
												className="w-full p-1 rounded-lg bg-zinc-800 border border-zinc-700 text-stone-200 text-sm"
											>
												<option value="">-----</option>
												{folders.map((folder) => (
											...
											<button
												...
												className="w-max p-1 border border-emerald-700 bg-emerald-950 rounded-lg text-xs md:text-base hover:bg-emerald-900 transition-all duration-300 flex items-center justify-center"
											>
				...
				<div className="my-4">
					<input
						...
						maxLength={10}
						className="border p-2 w-full rounded-lg text-stone-200 border-sky-700 bg-sky-950"
					/>
				</div>
				...
				<div className="">
					<textarea
						...
						className="border p-2 w-full rounded-lg text-neutral-950 bg-stone-200 h-80"
					/>
				</div>
			</div>
		</div>
